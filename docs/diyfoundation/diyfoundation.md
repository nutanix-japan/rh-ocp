...
2.  Confirm if your hardware nodes have 1 or more SSD and create your cluster
   
3.  2 SSDs are required to privide RF2 redundancy factor in a Nutanix cluster

    If we have only 1 SSD in our nodes as confirmed from the previous step, we are good to have RF1 as a redundancy factor.

    <Tabs groupId="Determine SSD">
    <TabItem value="2 SSDs Node" label="2 SSDs Node">
    ...
    <TabItem value="1 SSD Node" label="1 SSD Node">
