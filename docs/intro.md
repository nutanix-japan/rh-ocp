...
This workbook accompanies an instructor-led session that introduces Nutanix HCI, Infrastructure lifecycle management for OCP using
Nutanix tools, OCP using Nutanix HCI storage (volumes), and many common management tasks. Each section has a lesson and an exercise to give you hands-on experience. The instructor explains the exercises and answers any additional questions that you may have.
...
-   **Foundation a Nutanix Cluster** - 60 minutes
-   **Install Prism Central** - 30 minutes
...
1. Foundation a Nutanix cluster
   - Install hypervisor
   - Install Controller Virtual Machine (CVM)
   - Configure and create Nutanix cluster
  
2. Install Prism Central to administer your Prism Element cluster
   
3. OCP IPI Installation

4. Setting up Nutanix Storage CSI
   
   -   Nutanix Storage CSI  

5. OCP and Nutanix NDB
